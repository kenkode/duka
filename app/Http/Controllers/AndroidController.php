...
//    var_dump($data);die;
  ...
  public function getCategories(Request $request) {
   /* $accessories = Category::select("id", "name")->get();
    echo json_encode($accessories);
*/
     $names = Category::groupby('name')->orderby('name', 'asc')->pluck('name');
  ...
  public function getProducts(Request $request) {
    ...
    $products = Product::select("id", "name", "price","category_id")->where("category_id",$category->id)->get();
...
//    $columns = array_merge(array("sizes.id", "size", "price"), $column);
  ...
  public function populateOrder(Request $request) {
    $user = $request->user;
  ...
  public function authOrderKey(Request $request) {
  ...
  public function updateUser(Request $request) {
    $userDetails = json_decode($request->update);
    $userId = $request->user;
    $message;
